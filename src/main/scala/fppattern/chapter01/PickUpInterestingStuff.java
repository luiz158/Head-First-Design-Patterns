...
public class PickUpInterestingStuff {
    public static void main(String[] args) {
        ...
        listOfBooks.add(new Books("Carr", Lists.newArrayList("The Mad Hatter Mystery", "The Blind Barber")));
        listOfBooks.add(new Books("Christie", Lists.newArrayList("Death On The Nile", "Murder in Mesopotamia")));
